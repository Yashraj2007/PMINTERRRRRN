...
const RecommendationsPage = () => {
  ...
  const { data: profile } = useAPI(() => candidatesAPI.getProfile(), [])
  ...
  const refreshRecommendations = async () => {
    try {
      ...
      showSnackbar("Failed to refresh recommendations", "error")
    } finally {
      setRefreshing(false)
    }
  }
            ...
            (internship, index) =>
              ...
              >
                <Card sx={{ 
                  ...
                  border: `3px solid ${internship.attritionRisk <= 30 ? colors.success : 
                                     internship.attritionRisk <= 60 ? colors.warning : colors.error}`,
                  borderRadius: '20px',
                  position: 'relative',
                  overflow: 'visible',
                  ...
                  '&:hover': {
                    boxShadow: `0 20px 60px ${internship.attritionRisk <= 30 ? colors.success : 
                                                internship.attritionRisk <= 60 ? colors.warning : colors.error}30`,
                  },
                  ...
                  <CardContent sx={{ flexGrow: 1, pb: 1, p: 3 }}>
                    ...
                    <Box display="flex" alignItems="center" mb={2}>
                      ...
                      <Chip 
                        ...
                        size="small" 
                        sx={{
                          bgcolor: internship.distance <= 50 ? `${colors.success}20` : 
                                   internship.distance <= 200 ? `${colors.warning}20` : `${colors.error}20`,
                          color: internship.distance <= 50 ? colors.success : 
                                 internship.distance <= 200 ? colors.warning : colors.error,
                          fontWeight: 'bold'
                        }}
                      />
                    </Box>
                    ...
                    <Box display="flex" alignItems="center" mb={3}>
                      ...
                      <Typography 
                        variant="body1" 
                        fontWeight="bold" 
                        sx={{ color: colors.success, fontSize: '1.1rem' }}
                      >
                    ...
                    <Paper sx={{ 
                      ...
                      <Grid container spacing={2}>
                        {[
                          ...
                          { label: "Performance", value: internship.successPrediction.performanceScore, color: "primary" },
                    ...
                    <Box mb={2}>
                      ...
                      <LinearProgress 
                        ...
                        sx={{ 
                          ...
                          bgcolor: `${colors.primary}20`,
                          '& .MuiLinearProgress-bar': {
                            background: internship.matchScore >= 80 ? colors.gradient.success : 
                                       internship.matchScore >= 60 ? colors.gradient.secondary : colors.gradient.primary,
                            borderRadius: 4
                          }
                        }}
                      />
                      <Box display="flex" justifyContent="space-between" mt={1}>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {internship.matchScore >= 80 ? '🟢 Excellent' : 
                           internship.matchScore >= 60 ? '🟡 Good' : '🟠 Fair'}
                        </Typography>
                      </Box>
                    </Box>
                  </CardContent>
                  ...
                  <CardActions sx={{ p: 3, pt: 0, flexDirection: 'column', gap: 2 }}>
                    ...
                    <Box display="flex" width="100%" gap={1}>
                      <Button 
                        ...
                        startIcon={<Done />}
                        sx={{
                          background: internship.attritionRisk <= 30 ? colors.gradient.success : colors.gradient.primary,
                          fontWeight: 'bold',
                          py: 1.5,
                          '&:hover': {
                      ...
                      <IconButton 
                        ...
                        sx={{ 
                          bgcolor: compareList.find(item => item.id === internship.id) ? `${colors.secondary}20` : 'transparent',
