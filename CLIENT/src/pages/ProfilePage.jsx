...
const ProfilePage = () => {
  ...
  const skillOptions = [
    "React.js", "Node.js", "Python", "JavaScript", "HTML5", "CSS3", "MongoDB", "MySQL", "Express.js", "Vue.js",
    "Angular", "TypeScript", "Machine Learning", "Data Science", "AI/ML", "Docker", "AWS", "Git", "Java", "C++",
    "PHP", "Django", "Flask", "React Native", "Flutter", "Kotlin", "Swift", "Go", "Rust", "Ruby", "Laravel",
    "Spring Boot", "TensorFlow", "PyTorch", "Pandas", "NumPy", "Scikit-learn", "Figma", "Adobe XD", "Photoshop",
    "Canva", "WordPress",
  ]

  const interestOptions = [
    "Web Development", "Mobile Development", "Data Science", "Machine Learning", "AI Research", "Backend Development",
    "Frontend Development", "Full-Stack", "DevOps", "Cloud Computing", "Cybersecurity", "Game Development",
    "UI/UX Design", "Product Management", "Digital Marketing", "Content Writing", "Graphic Design", "Video Editing",
    "SEO/SEM", "E-commerce", "Blockchain", "IoT Development", "Robotics", "AR/VR Development",
  ]

  const collegeOptions = [
    // IITs
    "IIT Bombay", "IIT Delhi", "IIT Madras", "IIT Kanpur", "IIT Kharagpur", "IIT Roorkee", "IIT Guwahati",
    "IIT Hyderabad", "IIT Indore", "IIT Mandi", "IIT BHU Varanasi", "IIT Bhubaneswar", "IIT Gandhinagar", "IIT Jodhpur",
    
    // NITs
    "NIT Trichy", "NIT Warangal", "NIT Surathkal", "NIT Calicut", "NIT Durgapur", "NIT Rourkela", "NIT Jamshedpur",
    "NIT Kurukshetra", "NIT Allahabad", "NIT Bhopal",

    // Top Private
    "BITS Pilani", "VIT Vellore", "SRM University", "Manipal Institute of Technology", "Thapar Institute of Engineering",
    "PES University", "Amity University", "LPU Punjab", "Kalinga University", "Chitkara University", "Bennett University",

    // State Universities
    "Anna University", "Mumbai University", "Pune University", "Delhi University", "Jadavpur University",
    "Bangalore University", "Osmania University", "Andhra University", "Kakatiya University", "Rajasthan University",

    // Government Colleges
    "Delhi Technological University (DTU)", "Netaji Subhas University of Technology (NSUT)", "College of Engineering Pune (COEP)",
    "PSG College of Technology", "Thiagarajar College of Engineering", "Government College of Technology Coimbatore",
    "BMS College of Engineering", "RV College of Engineering", "MS Ramaiah Institute",

    // Other categories
    "Other Engineering College", "Arts & Science College", "Commerce College", "Polytechnic College",
  ...
  const locationOptions = [
    ...
    "Kochi", "Coimbatore", "Indore", "Bhopal", "Nagpur", "Surat", "Vadodara", "Remote",
  ]
  ...
  const { data: profileData, loading: profileLoading, mutate } = useAPI(() => candidatesAPI.getProfile(), [])
  ...
  const handleNext = () => {
    ...
    localStorage.setItem('pmis-profile-progress', JSON.stringify({
      formData,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updatedProfile = await mutate(() =>
        candidatesAPI.updateProfile(profilePayload)
      )
      ...
      setSaveStatus("error")
      showSnackbar(error.message || "Failed to create profile", "error")
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    helperText={validationErrors.skills || "Add skills that match your expertise. You can type custom skills too!"}
                  />
                )}
                sx={{ mb: 3 }}
              />
            ...
            {activeStep === steps.length - 1 ? (
              <Button
                ...
                sx={{
                  px: 4,
                  py: 1.5,
                  background: saveStatus === "saved" ? colors.gradient.success : 
                            saveStatus === "error" ? colors.gradient.error : colors.gradient.success,
                  "&:hover": {
